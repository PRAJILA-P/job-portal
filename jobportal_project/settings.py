...
SECRET_KEY = 'django-insecure-2n1@2w8iwr#k2gs8fuhf3s3wvd%iebm*20-=j@hb!^+$*%50xr'
...
EMAIL_HOST_PASSWORD = 'ugcr vncv ihxu krak'  # use App Password, not your Gmail password
